defmodule EpisodicalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EpisodicalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EpisodicalWeb.Gettext, "errors", msg, opts)
    end
  end
