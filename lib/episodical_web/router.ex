defmodule EpisodicalWeb.Router do
  use EpisodicalWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {EpisodicalWeb.Layouts, :root}
  ...
  scope "/", EpisodicalWeb do
    ...
    resources "/paths", PathsController
  end

  # Other scopes may use custom stacks.
  # scope "/api", EpisodicalWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:episodical, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EpisodicalWeb.Telemetry
