defmodule EpisodicalWeb.ProviderControllerTest do
  ...
  @create_attrs %{name: "my-provider", base_url: "https://localhost", model_type: "episodic", access_key: "secret", service_type: "thetvdb"}
  @update_attrs %{name: "actual-name", base_url: "https://locahost.alternate", model_type: "episodic", access_key: "fresh-key", service_type: "thetvdb"}
